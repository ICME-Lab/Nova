...
type S1 = nova_snark::spartan::delegatedsnark::RelaxedR1CSSNARK<E1, EE1, SparkEngine<E1>>; // non-preprocessing SNARK
type S2 = nova_snark::spartan::delegatedsnark::RelaxedR1CSSNARK<E2, EE2, SparkEngine<E2>>; // non-preprocessing SNARK
